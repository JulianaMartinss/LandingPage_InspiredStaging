      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={scrollContainerRef} className="flex overflow-x-auto gap-8 pb-8 -mx-4 px-4 md:mx-0 md:px-0 scroll-smooth snap-x snap-mandatory scrollbar-hide">
          {projects.map(project => {
            ...
            return (
              <div key={project.id} className="relative group rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer min-w-[300px] md:min-w-[400px] h-80 bg-stone-100 flex-shrink-0 snap-center border border-stone-200"
