...
const Projects: React.FC = () => {
  ...
  const homes = [
    ...
    {
      image: "https://images.unsplash.com/photo-1484154218962-a1c002085aac?auto=format&fit=crop&q=80&w=800",
    ...
    {
      image: "https://images.unsplash.com/photo-1600596542815-e32898fe63f7?auto=format&fit=crop&q=80&w=800",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {homes.map((home, index) => (
            <div 
              key={index} 
              className="group bg-white rounded-xl overflow-hidden border border-stone-100 shadow-sm hover:shadow-md transition-all flex-shrink-0 w-[85vw] md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.33rem)] snap-center"
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <a href="#" className="p-2 bg-soft-beige rounded-full text-stone-600 hover:bg-stone-200 transition-colors">
